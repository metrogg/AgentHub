...
<!-- AGENTHUB:BRIDGE-RUNTIME-CONTEXT:START -->
...
- Contract root: C:\Users\Mozero\AppData\Roaming\com.agenthub.desktop\AgentHub\workers\1c6fb1e2-b835-43d7-8135-4c4f1cb1292e
- Projected contract root: F:\Learning\AgentHub\.agenthub\worker-contract
- Projected SOUL: F:\Learning\AgentHub\.agenthub\worker-contract\SOUL.md
- Projected runtime manifest: F:\Learning\AgentHub\.agenthub\worker-contract\runtime-manifest.json
- Projected skills: F:\Learning\AgentHub\.agenthub\worker-contract\skills
## Runtime Rules
...
<!-- AGENTHUB:COLLABORATION-CONTEXT:START -->
## AgentHub Collaboration Context

- Worker instance: 1c6fb1e2-b835-43d7-8135-4c4f1cb1292e
- Workspace agent: f69fa220-919a-45b4-abe1-f12761fd91b4
- Runtime base: claude-code
- Runtime mode: bridge
- Model binding: ea2c58ad-759e-493a-8775-6e059db1aa63
- Matrix user id: unbound
- Participant id: unbound
- Sandbox policy: workspace-write
- Controller API: not injected
- Shared storage root: not injected

### Current Rooms
- 34fff189-65b5-4d82-b516-f783c87aaa73: task (34fff189-65b5-4d82-b516-f783c87aaa73)

### Runtime Adapter Contract
- Mode: bridge
- Base profile: Claude Code Worker
- Architecture mode: bridge
- Process model: AgentHub-managed CLI subprocess; long-running bridge is a later upgrade
- Resource profile: Bridge mode cost follows the native CLI process plus AgentHub supervision; it must expose the same Room/SOUL/AGENTS/skills/task contract even before it becomes a runtime-native Matrix listener.
- Matrix listener owner: agenthub-supervisor
- Matrix pattern: AgentHub Matrix listener imports room events, invokes the CLI bridge, then writes replies back to Matrix timeline
- Runtime readiness: claude command probe, native version check, model/auth/config, cwd, and WorkerRuntime heartbeat
...
- Parity capabilities: matrix_identity, room_timeline_io, mention_dispatch, SOUL.md, AGENTS.md, skills, workspace_contract, shared_task_contract, artifact_refs, runtime_prepare, runtime_health, heartbeat, stop_or_cancel, clarification_resume, transparent_blockers
- Diagnostic readiness source: inspectCodeAgentRuntime plus AgentHub-managed Matrix listener
- Blocking diagnostic signals: contract_missing, matrix_identity_missing, cli_not_installed, model_not_configured, execution_disabled, cwd_invalid, doctor_probe_failed_when_supported, worker_instance_failed
- Diagnostic probes: command-installed, native-version-probe, doctor-probe, capability-probe, model-binding-check, cwd-check
- Expected native capabilities: auth, mcp, nonInteractive, jsonOutput, sessionResume, agents, project, doctor
- Current limits: Bridge mode is compatible with the common contract but is not yet a runtime-native Matrix listener.
- Worker reconcile stages: EnsureIdentityAndWorkspace -> EnsureRuntimeConfig -> EnsureRuntimeReady -> ObserveHealthAndHeartbeat -> RecoverOrRetire
...
<!-- AGENTHUB:COLLABORATION-CONTEXT:END -->
<!-- AGENTHUB:BRIDGE-RUNTIME-CONTEXT:END -->
