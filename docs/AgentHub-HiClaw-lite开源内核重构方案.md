...
- RuntimeLease 已经在 Coordinator 单任务 `assign` 中创建独立 cwd/home/config/cache/tmp/data，并随 WorkerRuntime 完成释放/失败/等待人类澄清；但还没有覆盖所有旧执行入口和长期 Worker 生命周期。
