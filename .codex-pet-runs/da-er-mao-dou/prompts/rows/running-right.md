Create one horizontal animation strip for Codex pet `daermaodou`, state `running-right`.
...
Identity: same pet in every frame: A compact cozy mascot inspired by 大耳帽兜: tiny round body tucked into a soft hood with very large floppy ear-like side flaps, bright curious eyes, little mitten hands, warm helpful personality, plush fabric texture, palette of cloud white, charcoal ink, soft teal, honey amber accents, no text or logos.. Preserve silhouette, face, proportions, markings, palette, material, style, and props.
Style: Pet-safe sprite: compact full-body mascot, readable in a 192x208 cell, clear silhouette, simple face, stable palette/materials, and crisp edges for chroma-key extraction. Style `plush`: Soft plush toy mascot with rounded stitched forms, fuzzy fabric feel, simple sewn details, and readable toy-like proportions. User style notes: soft plush mascot, big readable hood-ear silhouette, clean sprite readability, crisp edges, no loose effects.
