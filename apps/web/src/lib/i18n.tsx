...
const zhToEn: Record<string, string> = {
  ...
  面板行为: 'Panel Behavior',
  '控制 TODO 和文件修改面板的自动打开/关闭行为': 'Control the auto open/close behavior of TODO and file change panels.',
  '收到 TODO 时自动打开 TODO 面板': 'Automatically open the TODO panel when TODO items arrive',
  '产生文件修改时自动打开文件修改面板': 'Automatically open the file changes panel when files change',
  '发送消息时自动关闭文件修改面板': 'Automatically close the file changes panel when sending a message',
  '发送新消息时自动关闭文件修改面板': 'Automatically close the file changes panel when sending a new message',
  '会话窗口中将用户消息右对齐': 'Right-align user messages in chat windows',
  '折叠已完成的工具调用': 'Collapse completed tool calls',
  '隐藏已完成思考块': 'Hide completed thinking blocks',
  'GIT 视图': 'Git View',
